...
1. Sign in using the same credentials you used to deploy Azure resources.  
...
1. Wait for the workspace to load, you should now see the **Training Images** page where images can later be uploaded and tagged.
