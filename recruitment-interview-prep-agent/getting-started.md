...
## Let's Get Started with Azure AI Services
...
1. Welcome to **Azure Portal**! You're now ready to start building your HR Interview Copilot using Azure AI Foundry, Azure OpenAI, Copilot Studio, and Power Automate.
