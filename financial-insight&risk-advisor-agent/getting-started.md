...
## Let's Get Started with Azure AI and Power BI
...
1. After signing in, ensure you can access:
   - **Azure AI Foundry / Azure OpenAI** (for the reasoning and summarization agent)
   - **Azure Document Intelligence** (for ingesting and extracting data from financial documents)
   - **Power Automate** (for alerts and workflow automation)
   - **Power BI** (for visualizing finance insights and anomalies)

1. You are now ready to start building your Financial Insight & Risk Advisor Agent that leverages document ingestion, AI reasoning, and automated alerting.
