...
1. After deployment completes, navigate to the **Foundry Portal**.

1. From the left-hand menu, select **Models + Endpoints**.

1. Click **Create Deployment** or **Deploy Base Model**.

1. From the model list, choose **gpt-4.1-mini**.
...
1. Once deployed, collect the following from the deployment details: 

   - **Model Deployment Name**  
   - **AZURE_OPENAI_ENDPOINT**  
   - **AZURE_OPENAI_KEY**

1. Save all three values in a notepad — they will be required for the application integration challenge.
